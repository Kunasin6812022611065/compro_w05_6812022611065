...
int main() {             // สร้างฟังก์ชั่นหลักของโปรแกรม เพื่อเป็นจุดเริ่มต้นการทำงานเมื่อรันโปรแกรม
    char name[31];       // สร้างตัวแปร name เพื่อมาเก็บค่า ชื่อ โดยใช้ String ที่สามารถเก็บได้ 30 ตัวอักษร (ใช้ char name[31] เนื่องจากต้องเผื่อตัวข้อความที่จะใส่ที่ตัวแปร name 1 ตัว)
    int age;             // สร้างตัวแปร age เพื่อมาเก็บค่า อายุ โดยใช้ int เนื่องจากต้องเก็บค่าตัวแปรเป็นเลขจำนวนเต็ม
    float height;        // สร้างตัวแปร height เพื่อมาเก็บค่า ส่วนสูง โดยใช้ float เนื่องจากต้องเก็บค่าตัวแปรเป็นเลขทศนิยม (ใช้ flaot เนื่องจากค่าที่ประกาศในตัวแปรเป็นทศนิยมไม่กิน 6 ตำแหน่ง)

    char subject;        // สร้างตัวแปร Subject เพื่อมาเก็บค่า ชื่อวิชา โดยใช้ char เนื่องจากค่าจะประกาศในตัวแปรเป็นตัวอักษรตัวเดียว
    float grade;         // สร้่างตัวแปร grade เพื่อมาเก็บค่า เกรด โดยใช้ float เนื่องจากต้องการประกาศค่าตัวแปรเป็นเลขทศนิยม (ใช้ flaot เนื่องจากค่าที่ประกาศในตัวแปรเป็นทศนิยมไม่กิน 6 ตำแหน่ง)
